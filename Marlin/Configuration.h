...
#define STRING_CONFIG_H_AUTHOR "Daniel Bull" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Modified NopHead Mendel90"
...
#ifdef PIDTEMPBED
// Mendel 90 heated bed @65
    #define  DEFAULT_bedKp 203.78
    #define  DEFAULT_bedKi 38.39
    #define  DEFAULT_bedKd 270.45
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define LEFT_PROBE_BED_POSITION -80 // Actually the right
    #define RIGHT_PROBE_BED_POSITION 25 // Actually left
    #define FRONT_PROBE_BED_POSITION -25 // Actually the back
     #define BACK_PROBE_BED_POSITION 80 // Actually the front
...
#define HOMING_FEEDRATE {3600, 3600, 240, 0}  // set the homing speeds (mm/min)
...
// Mendel90 hobbed bolt and 39:11 Wade's gears and Stoffel15 bolt
// (3200 * 39.0)/(11.0 * 6.75 * 3.142) ~= 535
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,200*16/1,524.5}  // Measured on Mendel90
